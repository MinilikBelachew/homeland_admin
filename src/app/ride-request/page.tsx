            ...
            <tbody>
              {rideRequests.map((rideRequest, index) => (
                <tr key={rideRequest.id} className="hover:bg-gray-100 dark:hover:bg-gray-800">
                  ...
                  <td className="py-4 px-6 text-left">{rideRequest.pickup_address}</td>
                  <td className="py-4 px-6 text-left">{rideRequest.dropoff_address}</td>
                  <td className="py-4 px-6 text-left">{rideRequest.car_details}</td>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg shadow-lg max-w-lg mx-auto p-6 relative">
              ...
              <div className="space-y-2">
                ...
                <p>
                  <strong>Dropoff Address:</strong> {selectedRide.dropoff_address}
                </p>
                <p>
                ...
                <p>
                  <strong>Package Description:</strong> {selectedRide.package_description}
                </p>
                <p>
